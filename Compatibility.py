...
from data import polyvore_dataset, DataGeneratorSiam
...
if __name__=='__main__':
    ...
    train_generator =  DataGeneratorSiam(train_set, dataset_size, params)
    test_generator = DataGeneratorSiam(test_set, dataset_size, params)
    ...
    results = siamese_net.fit_generator(generator=train_generator,
    ...
    siamese_net.save('polyvore_trainedq4.hdf5')
    ...
    np.savetxt('acc_q4.txt',acc)
    np.savetxt('val_acc_q4.txt',val_acc)
